...
public class Kits {
	...
	public static void kitPower(Player p) {
		...
		p.getInventory().setItem(2, ItemGen(Material.DIAMOND_CHESTPLATE, "§9Invulnérabiliter", LoreCreator("§9Clique droit - Rend invinsible pendant 3 secondes", ChatColor.BLUE+"15 secondes de récupération"), 1));
		p.getInventory().setItem(8, Bouf(Material.CARROT_ITEM, 64));
	...
	public static void kitInvocation(Player p) {
		...
		p.getInventory().setItem(0, ItemGen1(Material.STICK, Enchantment.DAMAGE_ALL, 1, "§fInvocation Stick", LoreCreator("§9Clique Droit - invoque un bouclier pendant 10s", "§945 secondes de récupération"), 1));
		p.getInventory().setItem(8, Bouf(Material.CARROT_ITEM, 64));
	}
	//MANQUE ABILITé
